...
undefined
list
LinkedList {head: Node, length: 2}head: Nodedata: "simba"next: Nodedata: "React"next: null[[Prototype]]: Object[[Prototype]]: Objectlength: 2[[Prototype]]: Object
class Node {
  constructor(data) {
      this.data = data;
      this.next = null;
